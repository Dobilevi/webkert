...
import {numberValidator} from "../../../shared/constants/validators";
...
export class TechnologyComponent implements OnInit, OnDestroy {
  ...
  surveyId: string = 'technology';

  surveyGroup: FormGroup = new FormGroup({
    phone: new FormControl('', [...numberValidator]),
    pc: new FormControl('', [...numberValidator]),
    tv: new FormControl('', [...numberValidator])
  });
